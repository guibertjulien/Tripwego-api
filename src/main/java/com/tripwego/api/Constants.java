...
public class Constants {
    ...
    public static final String DAY_IN = "day_in";
    ...
    public static final String URL_STATIC_MAP = "url_static_map";
    public static final String AVOID_HIGHWAYS = "avoid_highways";
    public static final String AVOID_TOLLS = "avoid_tolls";
    public static final String IS_DEFAULT = "is_default";
    public static final String VERSION_NUMBER = "version_number";
    public static final String VERSION_CREATED_AT = "version_created_at";
    public static final String VERSION_UPDATED_AT = "version_updated_at";
    ...
    public static final String URL_ALBUM_PHOTO = "url_album_photo";
    ...
    public static final String TRIP_PLAN_STATUS = "trip_plan_status";
